...
export default function Login(){
    ...
    const validationSchema = Yup.object({
        ...
        password: Yup.string().required("Password must be at least 8 characters long").min(8, "Password must be at least 8 characters long"),   
    });
            ...
            <section className={c.loginPage}>
                ...
                <div className={`${c.left}`}>
                    ...
                    <div className={`${c.formcontent}`} data-aos="fade-up" data-aos-offset="200" data-aos-delay="0" data-aos-duration="200">
                        <h1>Welcome back</h1>
                        <p>Sign in to your ExpenseVision account</p>
                        <Formik
                        ...
                        >
                            {({ isSubmitting, validateForm, setTouched, values, handleSubmit, }) => (
                                ...
                                >
                                    ...
                                    <div className={c.field}>
                                        <div className={`${c.input} `}>
                                            <div className='flex justify-between items-center'>
                                                ...
                                                <Link className={c.forgotPass} href={`/forgot-password`} >Forgot password?</Link>
                                            </div>
                                    ...
                                    <div className={`${c.check} flex items-center py-2`}>
